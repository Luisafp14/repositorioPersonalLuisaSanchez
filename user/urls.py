...
from .views import user_login, profile, add_car, car_profile, user_logout, chat_diagnostico, edit_profile, delete_profile, edit_car, diagnostico_view, ver_servicios, diagnostico_success, eliminar_servicio_carrito,  generar_factura
